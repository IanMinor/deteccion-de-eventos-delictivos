...
parser.add_argument('--rgb-list', default='data/ucf-i3d.train.list', help='list of training rgb features ')
parser.add_argument('--test-rgb-list', default='data/ucf-i3d.test.list', help='list of test rgb features ')
parser.add_argument('--gt', default='data/gt-ucf.npy', help='file of ground truth ')
